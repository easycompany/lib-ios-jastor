 ...
 */
enum {
	ISO8601DateFormatJASTORCalendar,
	ISO8601DateFormatJASTOROrdinal,
	ISO8601DateFormatJASTORWeek,
};
typedef NSUInteger ISO8601DateFormatJASTOR;

//The default separator for time values. Currently, this is ':'.
extern unichar ISO8601DefaultTimeSeparatorCharacter;

@interface ISO8601DateFormatterJASTOR: NSFormatter
{
	...
	ISO8601DateFormatJASTOR format;
...
@property ISO8601DateFormatJASTOR format;
